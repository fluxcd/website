...
[^1]: GOTK is shorthand for the [GitOps Toolkit](../components/) APIs and Controllers
...
[^2]: Versioning: Flux 2 is a multi-service architecture, so requires a more complex explanation than Flux 1:
     ...
     - The GitOps Toolkit APIs follow the [Kubernetes API versioning](https://kubernetes.io/docs/reference/using-api/#api-versioning) pattern. See [Roadmap](../../roadmap.md) for component versions.
