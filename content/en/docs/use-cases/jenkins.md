...
Flux represents this as a [`GitRepository` custom resource](../components/source/gitrepositories.md).
...
This is important since git tags can be used for [Automating image updates to Git](../guides/image-update.md) in production.
...
[using an ImagePolicy object]: ../guides/sortable-image-tags.md#using-in-an-imagepolicy-object
