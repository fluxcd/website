...
```bash
kubectl apply -k github.com/fluxcd/flagger/tree/main/kustomize/linkerd
```
...
```bash
kubectl apply -k https://github.com/fluxcd/flagger/tree/main/kustomize/tester
```

Create a deployment and a horizontal pod autoscaler:

```bash
kubectl apply -k https://github.com/fluxcd/flagger/tree/main/kustomize/podinfo
```
