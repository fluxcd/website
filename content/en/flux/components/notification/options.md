...
| `DisableConfigWatchers`       | `false`       | Disables the watchers for ConfigMaps and Secrets. By default, the controller will require list and watch for ConfigMaps and Secrets cluster-wide.                                                                         |
