...
[deployment YAMLs](https://github.com/fluxcd/helm-operator/tree/1.4.2/deploy).
...
```sh
kubectl apply -f https://raw.githubusercontent.com/fluxcd/helm-operator/1.4.2/deploy/rbac.yaml
```

Apply the Helm Operator deployment itself:

```sh
kubectl deploy -f https://raw.githubusercontent.com/fluxcd/helm-operator/1.4.2/deploy/deployment.yaml
```
...
and [commented out sections](https://github.com/fluxcd/helm-operator/blob/1.4.2/deploy/deployment.yaml)
