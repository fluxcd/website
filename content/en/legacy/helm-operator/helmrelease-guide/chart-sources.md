...
deployment](https://github.com/fluxcd/helm-operator/blob/1.4.2/deploy/deployment.yaml).
...
[example deployment](https://github.com/fluxcd/helm-operator/blob/1.4.2/deploy/deployment.yaml).
